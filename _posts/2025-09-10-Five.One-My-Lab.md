...
To maintain and collect all the logs, I have a log analytics workspace, it collects logs from On-prem DC and the user device. And it seems that this is it for the environment.  
